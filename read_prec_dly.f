...
c        number of stations <= nstat
      parameter( in=10, io=11, inf=12, nstat=3000 )
c     ****************************************************************
...
c     ****************************************************************
      ...
      character*28 name, name_old, stat_name
...
c     5    read(in,'(a22,i5)',end=199) name, iyr
 5    read(in,'(i6,1x,a28,1x,i4)',end=199) id(1), name, iyr
...
c            read(inf,'(33x,a22)') stat_name
            read(inf,'(32x,a28,1x,i6)') stat_name, id(2)
