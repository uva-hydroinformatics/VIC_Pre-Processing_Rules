...
c     ****************************************************************
      ...
      character*29 name, name_old, stat_name
...
c     5    read(in,'(a28,i5)',end=199) name, iyr
 5    read(in,'(i6,1x,a29,1x,i4)',end=199) id(1), name, iyr
...
c            read(inf,'(33x,a28)') stat_name
            read(inf,'(31x,a29,1x,i6)') stat_name, id(2)
...
c     name2 must be truncated, of the form ### TEXT_STRING
      ...
      if(find.ne.1 .or. .not.id_match)then
         ...
         print'(i6,1x,a29,1x,i6,1x,a29,1x,i4)',  
